...
- (void)layoutSubviews
{
    ...
    if ([self.bubbletype isEqualToString:@"LEFT"])
    {
        ...
        textLabelFrame.origin.x = 28;
        textLabelFrame.size.width = self.frame.size.width-94;
        textLabelFrame.size.height = labelSize.height + 6;
        textLabelFrame.origin.y = 12.0f + TOP_MARGIN + 4;
        self.textLabel.frame = textLabelFrame;
        messageBackgroundView.frame = CGRectMake(textLabelFrame.origin.x - 8, textLabelFrame.origin.y - 8, labelSize.width + 16,labelSize.height + 18);
    ...
    }else
    {
        ...
        textLabelFrame.size.width = self.frame.size.width-94;
        textLabelFrame.size.height = labelSize.height + 6;
        textLabelFrame.origin.y = 12.0f + TOP_MARGIN;
        textLabelFrame.origin.x = self.bounds.size.width - labelSize.width - 20;
        self.textLabel.frame = textLabelFrame;
        
        messageBackgroundView.frame = CGRectMake(textLabelFrame.origin.x -8, textLabelFrame.origin.y, labelSize.width + 16, labelSize.height + 18);
